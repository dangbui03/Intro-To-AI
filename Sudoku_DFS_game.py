...
def main():
    ...
    backtracking = pg.image.load(path.join('sprites', 'backtracking.png')).convert() 
    ...
    backtracking = pg.transform.scale(backtracking, (112 * scale, 11 * scale))
    ...
    while True:
        ...
        while (not start_button.clicked) and (not reset_button.clicked):
            ...
            window.blit(backtracking, (400, 600))
